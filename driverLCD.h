...
#define driverLCD_I2C                     I2C
#define driverLCD_I2C_PORT                GPIOB
#define driverLCD_SCL_PIN                 GPIO_Pin_6
#define driverLCD_SDA_PIN                 GPIO_Pin_7
#define driverLCD_I2C_SPEED               400000
